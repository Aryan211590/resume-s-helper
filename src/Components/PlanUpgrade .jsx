                ...
                <Container>
                    <Row>
                        ...
                        <Col className='mt-3' sm={6}>
                            <ul>
                                <li>
                                <PayPalScriptProvider options={{ "client-id": "AWTRtWQVAd4OaDMj_ILTz1q4XKPIldBJkqAejTkzdssbX8mgfkhFpo1NcpydD45Q52sxWmK_kITqHKcB" }}/>
                                    {/* <a className="started mt-4" href="dfkahsdkfjh">Continue</a> */}
                                    {/* <PayPalButton
                                        amount="0.01"
