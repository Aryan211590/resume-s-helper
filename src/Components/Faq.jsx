        ...
        <div>
            ...
            <div className="jumbotron-txt" >
                <div className="m-sections-container">
                    <h1 className="jumbotron-txt__title"> <b>Resume</b>Coach FAQ </h1>

                    <p className="jumbotron-txt__content"> Whether you’re creating your <b>first resume online</b>
                        or you’re a seasoned professional, ResumeCoach is here to<br /> help you <b>get the most out of your resume</b>. Here, you’ll find our list of Frequently Asked Questions to aid you with<br /> your winning resume creation. </p>
                </div>
            </div>
            <div id="content" className="m-sections-container">
                <div className="m-sections-twoSides--30 u-fl-left faq-aside">
                    <ul className="m-list-menu" id="nav">
                        <li className="m-list-menu-item"> <a className="m-list-menu-item-link" onclick="scrollToFaq()" href="#section1">Use of ResumeCoach</a> </li>
                        ...
                        <li className="m-list-menu-item"> <a className="m-list-menu-item-link" onclick="scrollToFaq()" href="#section3">How to create an effective resume with ResumeCoach</a> </li>
                ...
                <div className="m-sections-twoSides--70 u-fl-right faq-main" id="faqs-page">
                    <div id="faqs" className="faqs--single">
                        <div className="faqs__headline" id="section1">
                            <h2 className="headline__faqs">Use of ResumeCoach</h2>
                        </div>
                        <Accordion >
                            <Accordion.Item eventKey="0" className='my-4'>
                                <Accordion.Header><b><RiQuestionLine style={{ fontSize: "20px", marginRight: "10px" }} />How does ResumeCoach work?</b></Accordion.Header>
                                <Accordion.Body>
                                    <ul>
                                        <li>It really is as simple as 1, 2, 3…<br />
                                            1. Sign in to your ResumeCoach account and choose a resume template from our exclusive database.<br />
                            ...
                            <Accordion.Item eventKey="3" className='my-4'>
                                <Accordion.Header><b><RiQuestionLine style={{ fontSize: "20px", marginRight: "10px" }} />How long does it take to make my resume with ResumeCoach?</b></Accordion.Header>
                                <Accordion.Body>
                                    <ul>
                            ...
                            <Accordion.Item eventKey="7" className='my-4'>
                                ...
                                <Accordion.Body>
                                    <ul>
                                        <li> Yes, users can use any smartphone, tablet, iPad, desktop or laptop computer to access their account and all their saved resumes. Resumes will be saved automatically as you work. ResumeCoach allows its users to log into their account from any Internet access point in order to edit, download and send their resumes at any time from anywhere.</li>
                        ...
                        <Accordion.Item eventKey="0" className='my-4'>
                                ...
                                <Accordion.Body>
                                    <ul>
                                        <li> If you’re sure you’ve got your password and username correct but you can’t access your ResumeCoach account, send us an email at contact@resumecoach.com where our friendly support staff will be happy to help you find a solution!</li>
                            ...
                            <Accordion.Item eventKey="4" className='my-4'>
                                ...
                                <Accordion.Body>
                                    <ul>
                                        <li> If you decide to unsubscribe from ResumeCoach, you will still be able to view your resumes in your profile but will no longer be able to download them as you will not have access to the ResumeCoach subscription advantages. This way if at anytime you need to edit and download a new resume, you can easily re-subscribe through your profile page.If you wish to completely remove yourself from the ResumeCoach resume builder, you can send us an email at contact@resumecoach.com indicating your associated account email address.</li>
                        ...
                        <div className="faqs__headline" id="section3">
                            <h2 className="headline__faqs">How to create an effective resume with ResumeCoach</h2>
                        </div>
                        <Accordion >
                        <Accordion.Item eventKey="0" className='my-4'>
                                ...
                                <Accordion.Body>
                                    <ul>
                                        <li> If you’ve never written a formal resume, no problem! With ResumeCoach you can use our step-by-step program to develop a new resume which highlights the aspects that make you a professional. Either focusing on your job trajectory or your skills or a combination of both, depending on which you feel is more appropriate for your career or sector.</li>
                            ...
                            <Accordion.Item eventKey="4" className='my-4'>
                                ...
                                <Accordion.Body>
                                    <ul>
                                        <li>  Although it is not obligatory to have several versions of your resume, it is recommended. With the ResumeCoach resume creator you can make multiple versions of your resume and download them to apply for different positions or adapt specific resumes for separate companies or sectors.</li>
                            ...
                            <Accordion.Item eventKey="5" className='my-4'>
                                ...
                                <Accordion.Body>
                                    <ul>
                                        <li>   Do not worry! On ResumeCoach.com you will find helpful tips and real-life examples to give you a headstart to completing each resume section with your details. You can check out the tips and suggestions we offer in each step of the process as well.</li>
