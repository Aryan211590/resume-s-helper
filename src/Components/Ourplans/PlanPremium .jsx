      ...
      <div className="Premium-paln">
        <Container>
          <div className="Premium-heading text-center mb-5">
            ...
            <p>
              Give Resume's helper a try with your free download in TXT format, but
              upgrade to really boost your chances.
            </p>
          </div>
          <div className="read">
            <Row>
              <Col sm={6}>
                <Row>
                  <Col sm={6} className="mt-4">
                    ...
                    <p>
                      Download into the format you want including PDF and TXT
                      (DOC files coming soon).
                    </p>
                  </Col>
                  <Col sm={6}>
                    <img src={s7} alt="" />
              ...
              <Col sm={6}>
                <Row>
                  <Col sm={6} className="mt-4">
                    ...
                    <p>
                      Write your CV in a couple of minutes by copying, pasting,
                      and editing pre-written phrases.
                    </p>
                  </Col>
                  <Col sm={6}>
                    <img src={s8} alt="" />
